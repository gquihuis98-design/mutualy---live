...
const faqs = [
  ...
  {
    q: "How is Mutualy different from lead databases or intent data tools?",
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#eef1f7] text-[#0f1730]">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#04112b]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 md:px-6">
          <a href="#top" className="flex items-center gap-3 text-white">
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-[#4166ff] to-[#34d3c5] text-[22px] font-extrabold shadow-[0_10px_30px_rgba(52,211,197,0.18)]">
              M
            </span>
          ...
          <div className="border-t border-white/10 bg-[linear-gradient(180deg,#04112b,#06163a)] px-5 py-6 md:hidden">
            <div className="mx-auto max-w-6xl">
              ...
              <p className="mt-4 max-w-sm text-[15px] leading-8 text-white/45">
                Permission-based B2B matchmaking. Better conversations, better
                outcomes.
              </p>

              <div className="mt-8 space-y-5 text-[15px] text-white/65">
                {headerLinks.map((item) => (
                  <a
                    key={item.label}
                    href={item.href}
      ...
      <main id="top">
        <section className="relative overflow-hidden bg-[#04112b] pb-14 pt-10 text-white md:pb-20 md:pt-14">
          ...
          <div className="relative mx-auto max-w-6xl px-5 md:px-6">
            <div className="inline-flex rounded-full border border-[#3e62ff]/25 bg-[#2445d8]/18 px-4 py-2 text-sm font-medium text-white/85">
            ...
            <div className="mt-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              <div>
                ...
                <p className="mt-8 max-w-3xl text-[18px] leading-9 text-white/52 md:text-[20px]">
                  Mutualy replaces cold outreach with permission-based
                  matchmaking. Buyers set their priorities. Vendors match on
                  fit. Only relevant conversations happen.
                </p>
                ...
                <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center rounded-[22px] bg-gradient-to-r from-[#4166ff] via-[#3b91f6] to-[#34d3c5] px-7 py-5 text-[18px] font-semibold text-white"
                  >
                    Join Mutualy
              ...
              <div className="rounded-[32px] border border-white/10 bg-white/[0.05] p-5">
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="text-right">
                            <div className="text-[22px] font-bold text-[#39b2f0]">
                              {item.match}
                            </div>
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          {item.chips.map((chip) => (
                            <div
                              key={chip}
                              className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-[13px] text-white/65"
                            >
                              {chip}
                            </div>
                          ))}
        ...
        <section className="mx-auto max-w-6xl px-5 py-12 md:px-6 md:py-16">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            {problems.map((item) => (
              ...
              >
                <div
                  className={`flex h-16 w-16 items-center justify-center rounded-[20px] text-[28px] ${
                    item.highlight ? "bg-[#dcf7f2]" : "bg-[#f4f5fa]"
                  }`}
                >
                  {item.icon}
                </div>
                <h3 className="mt-8 text-[26px] font-bold text-[#0f1730]">
                  {item.title}
                </h3>
        ...
        <section className="mx-auto max-w-4xl px-5 py-12 md:px-6 md:py-16">
          <div className="text-center">
            <div className="text-sm font-semibold uppercase tracking-widest text-[#4166ff]">
              Try it yourself
            </div>
            <h2 className="mt-4 text-3xl font-extrabold text-[#0f1730] md:text-5xl">
              See how matching feels
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-[#6b7285]">
              Prospects can click through real-looking vendor matches on the
              page. Accept the ones that fit, decline the rest.
            </p>
          </div>
          ...
          <div className="mt-10">
            ...
            <div className="relative mx-auto max-w-3xl">
              ...
              <div className="relative overflow-hidden rounded-[30px] border border-[#d9deeb] bg-white p-6 shadow-[0_20px_60px_rgba(15,23,48,0.12)]">
                <div className="flex items-center justify-between gap-4">
                  <div className="flex min-w-0 items-center gap-4">
                    ...
                    <div className="min-w-0">
                      <div className="truncate text-xl font-semibold text-[#11182d]">
                        {currentMatch.name}
                      </div>
                  ...
                  <div className="shrink-0 text-right">
                    <div className="text-3xl font-bold text-[#34d3c5]">
                      {currentMatch.match}
                    </div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {currentMatch.tags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full border border-[#d7dcf4] bg-[#f7f8fd] px-3 py-1.5 text-xs text-[#4b5fd6]"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 border-t border-[#e5e7ef] pt-6 text-sm text-gray-600 sm:grid-cols-2">
                  <div>
                    <span className="font-semibold text-[#7b8193]">
                      Company
                    </span>
                    <div className="text-lg text-[#11182d]">
                ...
                <div className="mt-6 grid grid-cols-2 overflow-hidden rounded-2xl border border-[#e5e7ef]">
                  <button
          ...
          <div className="mt-10 space-y-6">
            {steps.map((item) => {
              ...
              return (
                <div
                  key={item.step}
                  className="flex items-start gap-5 rounded-[30px] border border-[#d9deeb] bg-white p-6 shadow-[0_14px_40px_rgba(15,23,48,0.05)] md:p-7"
                >
                  <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-[28px] bg-gradient-to-br from-[#4166ff] to-[#7c4df0] text-white">
                    <Icon size={34} />
                  </div>
                  <div className="pt-1">
                    <div className="text-[18px] font-semibold text-[#4166ff]">
                      {item.step}
                    </div>
                    <h3 className="mt-2 text-[30px] font-extrabold text-[#0f1730]">
                      {item.title}
                    </h3>
                    <p className="mt-4 text-[18px] leading-9 text-[#6b7285]">
                      {item.text}
                    </p>
                  </div>
                </div>
        ...
        <section className="relative overflow-hidden bg-[#04112b] py-14 text-white md:py-20">
          ...
          <div className="mx-auto max-w-6xl px-5 md:px-6">
              ...
              {matchSignals.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-8 text-[24px] font-bold text-white">
                      {item.title}
                    </h3>
                    <p className="mt-4 text-[18px] leading-9 text-white/46">
                      {item.text}
                    </p>
                  </div>
                );
            ...
            <div className="mt-8 rounded-[30px] border border-[#2fd7c1]/25 bg-[linear-gradient(180deg,rgba(20,53,86,0.64),rgba(10,26,56,0.6))] p-8 text-center">
              <h3 className="text-[28px] font-extrabold text-white md:text-[36px]">
                Permission-Based Pipeline™
              </h3>
              <p className="mx-auto mt-5 max-w-4xl text-[19px] leading-9 text-white/52">
                Every introduction on Mutualy requires buyer consent. Vendors
                never reach out cold — buyers choose to engage. This creates a
                pipeline built on mutual interest, not interruption.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-5 py-12 md:px-6 md:py-16">
          <SectionHeader
            ...
            subtitle="Mutualy is being designed around a simpler, cleaner way to create qualified introductions before public launch."
          />

          <div className="mt-12 grid gap-5 md:grid-cols-2">
            {[
              {
                title: "Fit-first experience",
                text: "Built around better matching, stronger relevance, and more qualified conversations.",
              },
              {
                title: "Lower-noise pipeline",
                text: "Designed to reduce cold outreach waste and help both sides spend time where fit already exists.",
              },
              {
                title: "Early-access product",
                text: "We’re intentionally building the product foundation before publishing customer proof or live performance claims.",
              },
              {
                title: "Buyer-controlled process",
                text: "Every introduction is permission-based, so discovery starts with buyer choice instead of interruption.",
              },
            ].map((item) => (
              <div
                key={item.title}
              ...
              >
                <div className="text-[24px] font-extrabold text-[#5a4cf0] md:text-[30px]">
                  {item.title}
                </div>
                <div className="mt-4 text-[18px] leading-8 text-[#6b7285]">
                  {item.text}
                </div>
              </div>
            ))}
        ...
        <section className="mx-auto max-w-5xl px-5 py-10 text-center md:px-6 md:py-12">
          <div className="rounded-[32px] border border-[#d9deeb] bg-white p-8 shadow-[0_14px_40px_rgba(15,23,48,0.04)] md:p-10">
            ...
            <div className="mt-5 text-[28px] font-extrabold text-[#11182d] md:text-[40px]">
              Mutualy is currently in early access.
            </div>
            <p className="mx-auto mt-5 max-w-3xl text-[18px] leading-9 text-[#6b7285] md:text-[20px]">
              We are focused on building the right product foundation before
              publishing customer logos, testimonials, or performance claims.
              Early-access members help shape the experience.
            </p>
            ...
            {faqs.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className="w-full rounded-[28px] border border-[#d9deeb] bg-white px-6 py-7 text-left shadow-[0_12px_34px_rgba(15,23,48,0.04)]"
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="text-[24px] font-bold text-[#11182d] md:text-[28px]">
                      {item.q}
                    </div>
                    <ChevronDown
                  ...
                  {isOpen && (
                    <div className="mt-5 max-w-4xl text-[18px] leading-9 text-[#6b7285]">
                      {item.a}
                    </div>
                  )}
                </button>
        ...
        <section className="relative overflow-hidden bg-[#04112b] py-16 text-white md:py-20">
          ...
          <div className="relative mx-auto max-w-5xl px-5 text-center md:px-6">
            ...
            <p className="mx-auto mt-7 max-w-4xl text-[19px] leading-9 text-white/50 md:text-[22px]">
              Join the platform where B2B conversations start with mutual
              interest, verified fit, and real buying intent.
            </p>
            <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center rounded-[22px] bg-gradient-to-r from-[#4166ff] via-[#3b91f6] to-[#34d3c5] px-8 py-5 text-[18px] font-semibold text-white"
              >
      ...
      <footer className="border-t border-white/8 bg-[#020617] px-5 py-10 text-center md:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="text-[28px] font-extrabold text-white">Mutualy</div>
          <p className="mt-3 text-[16px] leading-8 text-white/42">
            Permission-based B2B matchmaking.
          </p>
...
function SectionHeader({
  ...
  return (
    <div className="text-center">
      <div
        className={`text-[16px] font-semibold uppercase tracking-[0.2em] ${
          dark ? "text-[#34d3c5]" : "text-[#4166ff]"
        }`}
      >
        {eyebrow}
      </div>
      <h2
        className={`mx-auto mt-4 max-w-5xl text-[46px] font-extrabold leading-[1.05] tracking-[-0.06em] md:text-[76px] ${
          dark ? "text-white" : "text-[#0f1730]"
        }`}
      >
        {title}
      </h2>
      <p
        className={`mx-auto mt-6 max-w-4xl text-[19px] leading-9 md:text-[22px] ${
          dark ? "text-white/48" : "text-[#6b7285]"
        }`}
      >
        {subtitle}
      </p>
...
function SideCard({
  ...
  return (
    <div
      className={`rounded-[32px] border p-8 md:p-9 ${
        buyer
          ? "border-[#bcebe3] bg-[#effaf8]"
          : "border-[#cdd0fb] bg-[#f1f2ff]"
      }`}
    >
      <div
        className={`text-[18px] font-semibold uppercase tracking-[0.18em] ${
          buyer ? "text-[#34d3c5]" : "text-[#4166ff]"
        }`}
      >
        {eyebrow}
      </div>
      <h3 className="mt-5 text-[46px] font-extrabold leading-[1.1] tracking-[-0.05em] text-[#11182d]">
        {title}
      </h3>
      ...
      <div className="mt-7 space-y-5">
        {bullets.map((bullet) => (
          <div
            key={bullet}
            className="flex items-start gap-3 text-[18px] leading-8 text-[#11182d]"
          >
...
function PricingCard({
  ...
  return (
    ...
    >
      ...
      <div className="text-[28px] font-bold text-[#11182d]">{title}</div>
      <div className="mt-8 text-[58px] font-extrabold text-[#11182d]">
        {price}
      </div>
