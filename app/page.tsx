        ...
        <section className="mx-auto max-w-4xl px-5 py-12 md:px-6 md:py-16">
          ...
          <div className="mt-10">
            ...
            <div className="relative mx-auto max-w-3xl">
              ...
              <div className="relative overflow-hidden rounded-[30px] border border-[#d9deeb] bg-white p-6 shadow-[0_20px_60px_rgba(15,23,48,0.12)] transition-all duration-300">
        ...
        <section className="mx-auto max-w-6xl px-5 py-12 md:px-6 md:py-16">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            <div className="rounded-[28px] border border-[#d9deeb] bg-white p-7 shadow-[0_14px_40px_rgba(15,23,48,0.04)] md:p-8">
              <div className="text-[18px] font-semibold uppercase tracking-[0.18em] text-[#4166ff]">
                Why it matters
              </div>
            ...
            <div className="rounded-[28px] border border-[#d9deeb] bg-white p-7 shadow-[0_14px_40px_rgba(15,23,48,0.04)] md:p-8">
              <div className="text-[18px] font-semibold uppercase tracking-[0.18em] text-[#34d3c5]">
                Early access focus
              </div>
              <h3 className="mt-5 text-[34px] font-extrabold leading-[1.08] tracking-[-0.04em] text-[#11182d] md:text-[42px]">
            ...
            {[
              {
                ...
                text: "Every introduction is permission-based",
              },
              {
                title: "Fit-first",
                text: "Matches are based on relevance, not volume",
              },
              {
                title: "Less noise",
                text: "No spray-and-pray outbound motion",
              },
              {
                title: "Higher quality",
                text: "Built for stronger, more qualified conversations",
              },
            ].map((item) => (
              <div
                key={item.title}
                className="rounded-[28px] border border-[#d9deeb] bg-white p-7 text-center shadow-[0_14px_40px_rgba(15,23,48,0.04)] md:p-8"
              >
                <div className="text-[24px] font-extrabold tracking-[-0.04em] text-[#5a4cf0] md:text-[30px]">
                  {item.title}
                </div>
                <div className="mt-3 text-[18px] leading-8 text-[#6b7285]">
                  {item.text}
                </div>
              </div>
            ))}
  ...
  return (
    <div
      ...
      className={`rounded-[32px] border p-8 md:p-9 ${
        buyer ? "border-[#bcebe3] bg-[#effaf8]" : "border-[#cdd0fb] bg-[#f1f2ff]"
      }`}
    >
      <div
